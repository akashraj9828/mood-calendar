...
(function (factory) {
            ...
            "<% for(var i = 0; i < numberOfRows; i++){ %>" +
                ...
                "<% var d = j + i * 7; %>" +
                    "<td class='<%= days[d].classes %>'>" +
                        "<div class='day-contents' data-toggle='modal' data-target='#input_modal' data-date='<%=days[d].date._d  %>'><%= days[d].day %></div>" +
                    "</td>" +
                "<% } %>" +
                "</tr>" +
            "<% } %>" +
    ...
    Clndr.prototype.createDaysObject = function (startDate, endDate) {
        ...
        if (this.options.events.length) {
            ...
            if (this.options.showAdjacentMonths) {
                ...
                this.moodLastMonth = $(this.options.mood).filter(
                    function () {
                ...
                this.moodNextMonth = $(this.options.mood).filter(
                    function () {
                        var beforeStart = this._clndrEndDateObject
    ...
    Clndr.prototype.createDayObject = function (day, monthEvents,moods) {
        var j = 0,
            self = this,
            now = moment(),
            eventsToday = [],
    ...
    Clndr.prototype.render = function () {
        ...
        if (this.options.lengthOfTime.days) {
            ...
            data = {
                ...
                moodThisInterval: this.moodThisInterval,
            ...
            for (i = 0; i < this.options.lengthOfTime.months; i++) {
                ...
                moodThisInterval.push(this.moodThisInterval);
                months.push({
                    days: days,
            ...
            data = {
                ...
                daysOfTheWeek: this.daysOfTheWeek,
                moodLastMonth: this.moodLastMonth,
                moodNextMonth: this.moodNextMonth,
                moodThisInterval: moodThisInterval,
            ...
            data = {
                ...
                eventsNextMonth: this.eventsNextMonth,
                numberOfRows: Math.ceil(days.length / 7),
                moodThisMonth: this.moodThisInterval,
